        ...
        <div class="home-shell">
            <div class="home-heading-row">
                <div>
                    ...
                    <h2>Une pièce pour chaque dégustation.</h2>
                </div>
            ...
            <div class="home-category-grid">
                <a href="{{ route('boutique') }}#selection" class="home-category-card">
                    ...
                    <div>
                        ...
                        <strong>Découvrir la sélection →</strong>
                    </div>
                </a>
        ...
        <div class="home-shell">
            <div class="home-heading-row home-heading-row-products">
                <div>
                    ...
                    <h2>Nos pièces emblématiques.</h2>
                </div>

                <a href="{{ route('boutique') }}" class="home-text-link">Voir toute la boutique →</a>
            </div>
                ...
                <article class="home-product-card">
                    ...
                    <div class="home-product-body">
                        ...
                        <div>
                            ...
                            <a href="{{ route('boutique') }}#selection">Voir la pièce</a>
                        </div>
                    </div>
                </article>
    ...
    <section class="home-section home-story">
        <div class="home-shell home-story-grid">
            ...
            <div class="home-story-content">
                ...
                <h2>Le goût commence bien avant la cuisson.</h2>
    ...
    <section class="home-guide">
        <div class="home-shell home-guide-grid">
            <div>
                ...
                <h2>Peu d’artifices. Une cuisson précise.</h2>
            </div>
            ...
            <a href="{{ route('blog') }}" class="home-text-link">Lire nos conseils de cuisson →</a>
        </div>
    </section>
    ...
    <section class="home-section home-professional">
        <div class="home-shell home-professional-card">
            <div>
                ...
                <h2>Chefs, restaurateurs et bouchers.</h2>
                <p>
            ...
            <div class="home-professional-actions">
                <a href="{{ route('reserve.pro') }}" class="home-button home-button-light">
                    Voir la réserve professionnelle
                </a>
